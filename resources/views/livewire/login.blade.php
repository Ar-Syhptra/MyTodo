    ...
    <div class="border-4 border-indigo-400 bg-gray-50 min-h-full w-fit p-10 px-16 mx-auto rounded-2xl">
        ...
        <div class="mt-9 sm:mx-auto sm:w-full sm:max-w-sm">
            <form class="space-y-6" wire:submit="authenticate">
                ...
                <div>
                    <button type="submit"
                        class="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 focus:ring-4 focus:ring-blue-900">Sign
                        in</button>
                </div>
            </form>
            <p class="mt-10 text-center text-sm/6 text-gray-500">
                Don't have an account yet?
                <a href="/register" class="font-semibold text-indigo-600 hover:text-indigo-500" wire:navigate>register
                    now!</a>
            </p>
        </div>
    </div>
