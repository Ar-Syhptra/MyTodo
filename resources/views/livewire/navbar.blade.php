<div>
    <nav class="bg-gray-800 border-gray-700">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse" wire:navigate>
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-solid-bg">
                <ul
                    ...
                    <li>
                        <a href="{{ route('login') }}"
                            class="block py-2 px-3 rounded-sm md:hover:bg-transparent md:border-0 md:py-2 md:px-2 text-white hover:bg-gray-700 hover:text-white"
                    ...
                    <li>
                        ...
                        block py-2 px-3 rounded-sm md:border-0 md:p-0 text-white sm:hover:bg-gray-700 hover:text-white
                          md:focus:ring-4 md:focus:ring-blue-300 md:font-medium md:rounded-lg md:text-sm md:px-5 md:py-2.5 md:me-2 md:mb-2 md:bg-blue-600 md:hover:bg-blue-700 md:focus:outline-none focus:ring-blue-900"
